...
public class Home extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String[] columns = {"FirstName", "LastName", "Title", "City", "Country", "ReportsTo"}; //only to change rows
        String[] values = {fName, lName, title, city, country, reportsToID};                    //only to change rows
        query.insert(columns, values, "Employees");                //only to change table name
        tableRefresh();
